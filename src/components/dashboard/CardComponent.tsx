...
export default function CardComponent({ card }: CardComponentProps) {
  return (
    <div
      className={`p-6 rounded-2xl w-[350px] relative ${
        card.type === 'credit'
    ...
    >
      ...
      <div className="relative">
        <div className="flex justify-between items-start mb-8">
          <div>
            <p className={`text-sm font-medium ${card.type === 'credit' ? 'text-white' : 'text-gray-500'}`}>
              Balance
            </p>
        ...
        <div className="flex justify-between items-center ">
          ...
          <img
            ...
            alt="Card Circle"
            loading="lazy"
            className={`h-8 ${card.type === 'credit' ? 'opacity-100' : 'opacity-30'}`}
          />
        </div>
      </div>
    </div>
